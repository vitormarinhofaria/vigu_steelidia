...
void loop(void)
{
    ...
    String sValue = String("Valor: " + String(input.get_rotary_val()));
    auto preDelay = millis();
    delay(16);
    auto total = millis() - preDelay;
    String sCounter = String("Contador: " + String(total));
    ...
    do
    {
        ...
        u8g.drawStr(0, 10, sValue.c_str());

        u8g.setFont(u8g_font_4x6);
        u8g.drawStr(0, 34, sCounter.c_str());
